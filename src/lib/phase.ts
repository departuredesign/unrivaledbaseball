...
export const FOOTER = {
  ...
  properties: [
    { label: 'Cooperstown',            href: '/cooperstown/',                    phase: 2 },
    { label: 'Rocker B Ranch',         href: '/rocker-b/',                       phase: 2 },
    { label: 'Ripken Experience',      href: '/ripken-aberdeen/',                phase: 2 },
    { label: 'Sports Force Parks',     href: '/sports-force-parks-cedar-point/', phase: 2 },
...
export const PAGE_PHASES: Readonly<Record<string, Phase>> = {
  ...
  '/cooperstown/':                       2,
  '/rocker-b/':                          2,
  '/sports-force-parks-cedar-point/':    2,
  '/sports-force-parks-manteca/':        2,
  '/ripken-aberdeen/':                   2,
  '/ripken-myrtle-beach/':               2,
  '/ripken-pigeon-forge/':               2,
  '/baseball-factory/':                  2,
  '/all-ripken/':                        2,
  '/prospect-select/':                   2,
  '/spring-training/':                   2,
